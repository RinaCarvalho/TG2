...
if __name__ == "__main__":
    ...
    if prompt:
        prompt_gen = PromptGenerator(prompt=prompt, problem=problem_id, technique=Technique.FEW_SHOT, variation=Variation.FORMATTING)
        ...
        code_gen.generate_code(prompt_series, prompt, 2, log_path)
